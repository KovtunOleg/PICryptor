...
6. For all targets Look for the *Import Paths* build setting and add to it `"$(PROJECT_DIR)/Carthage/Checkouts/PICryptor/Scripts"`
![Alt text](https://monosnap.com/file/jlEb3MWKMPVI8YiRtjdHT6UUxmHTbc.png)
